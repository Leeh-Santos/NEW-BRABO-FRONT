...
const TIERS = [
  { key: "bronze", name: "Bronze", thresholdUsd: 5, icon: "🥉" },
  { key: "silver", name: "Silver", thresholdUsd: 50, icon: "🥈" },
  { key: "gold", name: "Gold", thresholdUsd: 100, icon: "🥇" },
] as const;
