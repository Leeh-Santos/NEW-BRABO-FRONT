 ...
 * class names are content-hashed and cannot be safely overridden from our CSS.
          ...
          >
            {(() => {
              ...
              if (chain.unsupported) {
                return (
                  <button type="button" className="wallet-connect is-wrong" onClick={openChainModal}>
                    Wrong network
                  </button>
                );
              }
              ...
              return (
                <>
                  ...
                  <button type="button" className="wallet-chip wallet-account" onClick={openAccountModal}>
